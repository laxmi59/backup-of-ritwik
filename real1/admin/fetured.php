...
<tr>
	...
	<? if($_GET['act']=='build'){?>
	<table width="80%">
	<tr><td align="center"><a href="fetured.php?act=buildadd">Add new Featured Builder</a></td></tr>
	<tr>
		<td>
			...
			<tr>
				<td align="center"><?=$cc1['build_id']?></td>
				<td align="center"><?=$cc1['build_city']?></td>
				<td align="center"><img src="img/<?=$cc1['build_img']?>" width="160" height="60" /></td>
				<td align="center">
					<a href="fetured.php?act=buildadd&id=<?=$cc1['build_id']?>">Edit</a>&nbsp;&nbsp;
	...
	<table>
		...
		<? if($_GET['id']<>''){?>
		<tr><td colspan="3" align="center">Edit Record</td></tr>
		<? }else{?>
		<tr><td colspan="3" align="center">Add new Record</td></tr>
		<? }?>
		<tr><td colspan="3">&nbsp;</td></tr>
		<tr>
			<td>City</td>
	...
	<table width="80%">
	<tr>
	  <td align="center"><a href="fetured.php?act=projadd">Add new Featured Projects </a></td>
	</tr>
	<tr>
		<td>
			...
			while($cc1=mysql_fetch_array($cc)){?>
			<tr>
				<td align="center"><?=$cc1['proj_id']?></td>
				<td align="center"><?=$cc1['proj_city']?></td>
				<td align="center"><img src="img/<?=$cc1['proj_img']?>" width="160" height="60" /></td>
				<td align="center">
					<a href="fetured.php?act=projadd&id=<?=$cc1['proj_id']?>">Edit</a>&nbsp;&nbsp;
					<a href="javascript:del(<?=$cc1['cid']?>)">Delete</a>
				</td>
			</tr>
			<? }?>

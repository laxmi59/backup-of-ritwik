...
//$filePath = "main.php?lk=home&act=user&";
//$filePath1 = "main.php?lk=home&act=list&";
//$filePath2 = "main.php?lk=home&act=post&";
?>
...
<tr>
	<td>
		...
		<tr class="tabcolor">
			<td colspan="3" align="center">
				<input type="button" name="btn" value="Edit" onclick="javascript:location='main.php?lk=home&act=profile1'"  class="btn" />
			</td>
		</tr>
		<tr class="linebreak"><td colspan="3">&nbsp;</td></tr>
		</table>
		...
		if($_POST['btn']){
			...
			//header('location:main.php?lk=home&act=profile');
			echo "<script>location.replace('main.php?lk=home&act=profile')</script>";
			}
		?>
	<? }?>
	<? //////////////////////////////////////////////////////////////////////////////////////////////////////////?>
	...
	<? }?>
	<? if($_GET['act']=='listactive' || $_GET['act']=='listnew' || $_GET['act']=='listblock'){?>
	...
	<? 	//$a=new list2();
		if($_GET['act']=='listactive'){
			...
			$i=mysql_query("select * from `real-list` where list_status='a' LIMIT $start, $q_limit");
			$filePath="main.php?lk=home&act=listactive&";
			
		}elseif($_GET['act']=='listnew'){
			$pid= "n";
			$num1=$list->listactive($pid);
			$i=mysql_query("select * from `real-list` where list_status='n' LIMIT $start, $q_limit");
			$filePath="main.php?lk=home&act=listnew&";
		}elseif($_GET['act']=='listblock'){
			$pid= "d";
			$num1=$list->listactive($pid);
			$i=mysql_query("select * from `real-list` where list_status='d' LIMIT $start, $q_limit");
			$filePath="main.php?lk=home&act=listblock&";
		}
	...
	<tr class="tabcolor">
		...
		<td style="padding-left:10px;"><? print $list->exp1($xx['list_date']);?></td>
		<?
			if($xx['list_type']=='1')
		    { $b= "Rent";}
		...
		<? //$abc=$reg->reg1($xx['r_id']);
			//echo $abc;
		//echo $a['r_id']?>
		<td class="trpad"><? print $reg->reg1($xx['r_id']);?></td>
		<td style="padding-left:10px;">
			<? if($_GET['act']=='listactive'){?>
				<a href="main.php?lk=home&act=block&id=<?=$xx['list_id']?>&name=<?="listactive"?>">Block</a>
			<? }else if($_GET['act']=='listnew'){?>
				<a href="main.php?lk=home&act=accept&id=<?=$xx['list_id']?>&name=<?="listnew1"?>">Active</a>
				<a href="main.php?lk=home&act=block&id=<?=$xx['list_id']?>&name=<?="listnew2"?>">Block</a>
			<? }else if($_GET['act']=='listblock'){?>
				<a href="main.php?lk=home&act=accept&id=<?=$xx['list_id']?>&name=<?="listblock"?>">Active</a>
			<? }?>
		</td>
	</tr>
	<? }}?>
	...
	<tr class="tabcolor">
		...
		<td><? print $reg->reg1($xx['r_id']);?></td>
		<td style="padding-left:10px;">
			<? if($_GET['act']=='postactive'){?>
				<a href="main.php?lk=home&act=block&id=<?=$xx['req_id']?>&name=<?="postactive"?>">Block</a>
			<? }else if($_GET['act']=='postnew'){?>
				<a href="main.php?lk=home&act=accept&id=<?=$xx['req_id']?>&name=<?="postnew1"?>">Active</a>
				<a href="main.php?lk=home&act=block&id=<?=$xx['req_id']?>&name=<?="postnew2"?>">Block</a>
			<? }else if($_GET['act']=='postblock'){?>
				<a href="main.php?lk=home&act=accept&id=<?=$xx['req_id']?>&name=<?="postblock"?>">Active</a>
			<? }?>
		</td>
	</tr>
	<? }}?>
	...
	<table border="0"  width="90%" align="center" cellpadding="0" cellspacing="0" class="innertab">
		<tr>
			...
			<td class="style3">Requirements</td>
			<td class="style3">listings</td>
			<td class="style3">Action</td>
		</tr>
		...
		<tr class="tabcolor">
			<!--<td align="center"><input type="checkbox" name="myCheckbox" ></td>-->
			<td><?=$active['r_un']?></td>
			<td><? print $loc->country($active['country'])?></td>
			<td><? print $loc->city1($active['location'])?></td>
			<td><? print $post->totpost($active['r_id'])?></td>
			<td><? print $list->totlist($active['r_id'])?></td>
			<td>
			<? if($_GET['act']=='active'){?>
				<a href="main.php?lk=home&act=block&id=<?=$active['r_id']?>&name=<?="regactive"?>">Block</a>
			<? }else if($_GET['act']=='new'){?>
				<a href="main.php?lk=home&act=accept&id=<?=$active['r_id']?>&name=<?="regnew1"?>">Active</a>
				<a href="main.php?lk=home&act=block&id=<?=$active['r_id']?>&name=<?="regnew2"?>">Block</a>
			<? }else if($_GET['act']=='block'){?>
				<a href="main.php?lk=home&act=accept&id=<?=$active['r_id']?>&name=<?="regblock"?>">Active</a>
			<? }?>
			</td>
		</tr>
		<tr class="tabcolor"><td colspan="7">&nbsp;</td></tr>
	...
	<? if($_GET['act']=='accept'){
		...
		if($_GET['name']=='postnew1' || $_GET['name']=='postblock'){
			...
			if($_GET['name']=='postnew1'){
				echo "<script>location.replace('main.php?lk=home&act=postnew')</script>";
			}elseif($_GET['name']=='postblock'){
				echo "<script>location.replace('main.php?lk=home&act=postblock')</script>";
			}
		}
		////////////////////////// for list properties///////////////////////////////
		if($_GET['name']=='listnew1' || $_GET['name']=='listblock'){
			...
			if($_GET['name']=='listnew1'){
				echo "<script>location.replace('main.php?lk=home&act=listnew')</script>";
			}elseif($_GET['name']=='listblock'){
				echo "<script>location.replace('main.php?lk=home&act=listblock')</script>";
			}
		}
		////////////////////////// for users///////////////////////////////
		if($_GET['name']=='regnew1' || $_GET['name']=='regblock'){
			...
			if($_GET['name']=='regnew1'){
				echo "<script>location.replace('main.php?lk=home&act=new')</script>";
	...
	<? if($_GET['act']=='block'){
		...
		if($_GET['name']=='postnew2' || $_GET['name']=='postactive'){
			...
			if($_GET['name']=='postnew2'){
				...
				echo "<script>location.replace('main.php?lk=home&act=postactive')</script>";
			}
		}
		////////////////////////// for list properties///////////////////////////////
		if($_GET['name']=='listnew2' || $_GET['name']=='listactive'){
			...
			if($_GET['name']=='listnew2'){
				...
				echo "<script>location.replace('main.php?lk=home&act=listactive')</script>";
			}
		}
		////////////////////////// for users///////////////////////////////
		if($_GET['name']=='regnew2' || $_GET['name']=='regactive'){
			...
			if($_GET['name']=='regnew2'){
				...
				echo "<script>location.replace('main.php?lk=home&act=active')</script>";
			}
		}
	}?>
	</td>

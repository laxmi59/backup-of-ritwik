...
$filePath = "main.php?lk=location&act=city&";
$filePath1 = "main.php?lk=location&act=area&";
...
<tr>
	...
	<tr>
		<td align="center" valign="top">
			<table width="80%">
			<tr>
				<td width="43%"><div align="center">City Name</div></td>
				<td width="4%">:</td>
	...
	<tr>
		<td valign="top">
			...
			<tr>
				<td width="44%"><div align="center">City Name </div></td>
				<td width="4%">:</td>
				<td width="52%">
					<select name="area1">
			...
			$abc=mysql_fetch_array(mysql_query("select * from `real-area` where aid='".$_GET['id']."'"));
				...
				<td><div align="center">Area Name</div></td><td>:</td>
		...
		<td valign="top">
			...
			<tr>
				...
				<td align="center">
					...
					<a href="javascript:del1(<?=$cc1['aid']?>)">Delete</a>
				</td>
			</tr>
			<? }?>
			<tr>

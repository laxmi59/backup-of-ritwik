...
class real_list
{
	...
	function listactive($id){
		$x=mysql_query("select * from `real-list` where list_status='".$id."'");return $x;	}
	// activate lists	
	function listactive1($id){
		$x=mysql_num_rows(mysql_query("select * from `real-list` where list_status='".$id."'"));return $x;	}
	// for recent posts	
	function recent(){
	...
	function areasid($id){
		$x=mysql_query("select * from `real-list` where list_location='".$id."'"); return $x;}
...
class real_location
{
	...
	function location($id)	{
		$aa=mysql_fetch_array(mysql_query("select * from `real-city1` where city_id='".$id."'"));
		$a=$aa['name']; return $a;}
	// for myreg country

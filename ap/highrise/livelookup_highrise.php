...
$highrise_url = 'http://ritwik2.highrisehq.com'; //Your Highrise URL, something like http://userscape.highrisehq.com
$api_token = '1de60ba35510d049ecf7d6d70facfa5f'; //You can find this in your Highrise account in the "my info" screen
...
$curl = curl_init($highrise_url.'/people.xml?term='.urlencode($_REQUEST['first_name'].' '.$_REQUEST['last_name']));

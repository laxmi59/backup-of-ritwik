...
/*
This function will check to see if 1 or more packages has the available feature enabled, 
if not it will hide the entire row.
*/
...
<div class="padding"> 
	...
	<article>
		...
		<div class="clearfix"></div>
			...
			<?php if(CanShowRow($packdata, "a1")){ ?><li class="<?php if( $packdata[$i]['a1'] == 1 ){ echo "yes"; }else{ echo "no"; } ?>"><?php echo $GLOBALS['_LANG']['_35_4']; ?></li><?php } ?>
            <?php if(CanShowRow($packdata, "a2")){ ?><li class="<?php if( $packdata[$i]['a2'] == 1 ){ echo "yes"; }else{ echo "no"; } ?>"><?php echo $GLOBALS['_LANG']['_35_5']; ?></li><?php } ?>
            <?php if(CanShowRow($packdata, "a3")){ ?><li class="<?php if( $packdata[$i]['a3'] == 1 ){ echo "yes"; }else{ echo "no"; } ?>"><?php echo $GLOBALS['_LANG']['_35_6']; ?></li><?php } ?>
            <?php if($showmaps != "no" && CanShowRow($packdata, "a4")){ ?><li class="<?php if( $packdata[$i]['a4'] == 1 ){ echo "yes"; }else{ echo "no"; } ?>"><?php echo $GLOBALS['_LANG']['_35_8']; ?></li><?php } ?>
                        
             
            
           <?php if(CanShowRow($packdata, "a5")){ ?> <li class="<?php if( $packdata[$i]['a5'] == 1 ){ echo "yes"; }else{ echo "no"; } ?>"><?php echo $GLOBALS['_LANG']['_35_7']; ?></li> <?php } ?>
			...
			<div class="griddler-controls"><a class="button" href="#" onclick="document.getElementById('packageID').value='<?php echo $i; ?>';document.hiddenPackage.submit();">
			<?php echo SPEC($GLOBALS['_LANG']['_block_p5']); ?></a></div>			

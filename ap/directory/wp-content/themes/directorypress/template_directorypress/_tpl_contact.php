...
<script language="javascript" type="text/javascript">
		...
		function CheckFormData()
		{
			...
			if(name.value == '')
			{
				alert('Please complete all of the contact form fields.');
				name.focus();
				return false;
			}
			if(email1.value == '')
    ...
    <p class="f_half left"> 
        ...
        <input type="text" name="form[name]" id="name" value="<?php echo $userdata->user_nicename; ?>" class="short" tabindex="1" /><br /> 
        
    </p> 
    <p class="f_half left"> 
        <label for="email"><?php echo SPEC($GLOBALS['_LANG']['_tpl_contact3']) ?><span class="required">*</span></label><br /> 
        <input type="text" name="form[email]" id="email1" value="<?php echo $userdata->user_email; ?>" class="short" tabindex="2" /><br /> 
    ...
    <p>
       ...
       <textarea tabindex="4" class="long" rows="4" name="form[message]" id="message"><?php if(isset($_POST['form']['message'])){  print strip_tags($_POST['form']['message']); }?></textarea><br /> 
    ...
    <p class="f_half left"> 
        ...
        <input type="text" name="form[code]" value="" class="short" tabindex="1" id="code" /><br /> 

...
<?php	
	...
	echo '<div id="premiumpress_box1" class="premiumpress_box premiumpress_box-100" style="width:680px !important;"><div class="premiumpress_boxin" style="width:680px !important;"><div class="header" style="height:32px;">
<h3 style="background:none;font-size:18px;margin-left:0px;padding-left:0px;border-bottom-color:none;box-shadow:none;border-bottom-style:none;"><img src="../wp-content/themes/directorypress/images/premiumpress/h-ico/open alt.png" align="middle" style="padding-right:10px;"> Options</h3>	 <a class="premiumpress_button" href="javascript:void(0);" onclick="PPHelpMe(\'addlisting\')">Help Me</a>						 
<ul>
...
<div id="premiumpress_tab5" class="content">';
	...
	echo '<table width="100%"  border="0"><tr width="50%"><td valign="top">';
		...
		echo '<label style="font-size:14px; line-height:30px;">' . __("<b>Email Address</b> <br /> <small> used for the claim listing feature only </small>", 'sp' ) . '</label><br />';
 ...
 echo '<label style="font-size:14px; line-height:30px;">' . __("<b>Reciprocal link</b> <br /> <small>only visible if added by the user during submission</small>", 'sp' ) . '</label><br />';
		echo '<input type="text" name="field[reclink]" value="'.get_post_meta($post->ID, 'reclink', true).'" style="font-size:14px;padding:5px; width:95%; background:#e7fff3;" /><br /><br />';

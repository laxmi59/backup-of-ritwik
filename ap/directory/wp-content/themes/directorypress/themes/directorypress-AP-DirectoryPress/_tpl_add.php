...
<?php if(isset($data) && get_option('pak_enabled') ==1 ){ ?>
 ...
 <?php } ?>       
        ...
        <div class="full clearfix border_t box"> 
            ...
            <p class="f_half left"> 
                <label for="email"><?php echo SPEC($GLOBALS['_LANG']['_tpl_add11']) ?> <span class="required">*</span>
				<?php if($_POST['packageID']==2){?><span style="font-weight:normal"><i>(Select up to 3)</i></span><?php }?>
				 </label><br /> 
        ...
        <div class="full clearfix border_t box">         
        <p>
            <label for="comment"><?php echo SPEC($GLOBALS['_LANG']['_tpl_add12']) ?> (max 250 characters)<span class="required">*</span></label><br /> 
        ...
        <p class="f_half left"> 
            <label for="name"><?php echo 'Affiliate Program URL' ;//SPEC($GLOBALS['_LANG']['_tpl_add20']) ?><span class="required">*</span></label><br />
...
<div class="full clearfix border_t box"> 
   ...
   <?php } $i++; } }  ?>
	...
	<div style="clear:both">(Note: Listing Logos should be sized as 134px by 50px)</div>    
    </div>      
...
<p style="font-size:16px;"><?php echo "Click 'Checkout' below to continue to paypal and purchase the following listing: <br /><br />"?><?php echo strip_tags($PACKAGE_OPTIONS[$_POST['packageID']]['name']); ?><?php echo " - "?><?php echo $PPT->Price($newPrice,$GLOBALS['premiumpress']['currency_symbol'],$GLOBALS['premiumpress']['currency_position'],1); ?>
<?php //echo SPEC($GLOBALS['_LANG']['_tpl_add37']) ?> <?php //echo $PPT->Price($newPrice,$GLOBALS['premiumpress']['currency_symbol'],$GLOBALS['premiumpress']['currency_position'],1); ?></p>
                ...
                <tr style="height:60px; background:#eee; border-bottom:1px solid #cccccc;">
                <td width="150">&nbsp;&nbsp;<b><?php echo "Pay now with";//get_option($Value['function']."_name"); ?></b></td>    
                <td width="220"><?php //if(strlen(get_option($Value['function']."_icon")) > 5){ echo "<img src='".get_option($Value['function']."_icon")."' />"; } ?><img src="/directory/wp-content/themes/directorypress/template_directorypress/images/buy_paypal.gif" width="131"/></td>
                
                <td width="253"><?php echo $Value['function']($_POST); ?></td>
                </tr>

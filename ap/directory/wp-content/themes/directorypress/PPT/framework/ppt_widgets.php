...
<input type="hidden" id="ppt_control_3_submit" name="ppt_control_3_submit" value="1" />
 <p>To edit the category display order change the settings under the <a href="admin.php?page=setup">general setup -> categories</a> tab.</p>
<p><b>Box Title:</b></p>
<input class="widefat" type="text" id="ppt_control_3_widget_title" name="ppt_control_3_widget_title" value="<?php echo get_option("ppt_control_3_widget_title"); ?>" />
            ...
            <p><br/><b>Display on which pages</b></p>
...
<p><br /><b>Show How Many Products?</b></p>
...
<p><br /><b>From Which Category?</b></p>
...
<br /><p><b>How many articles to display?</b></p>
<input class="widefat" type="text" id="display_sidebar_articles_count" name="display_sidebar_articles_count" style="width:60px;" value="<?php echo get_option("display_sidebar_articles_count"); ?>" />

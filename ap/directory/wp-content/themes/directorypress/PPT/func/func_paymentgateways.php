...
function gateway_paypal($data=""){
	...
	$package_name = $packages[$data['packageID']]['name'];
	$gatewaycode .= '<input type="hidden" name="item_name" value="'.strip_tags($package_name).' - '.$data['form']['title'].'">
	<input type="hidden" name="amount" value="'.$data['price']['total'].'">';
	}
...
<div class="clearfix"></div>
<p class="f_half left">
<label class="col1">Postal/ZIP Code:</label><br />

...
<?php if($order->order_coupon > 0){ ?>
     <tr> 
      ...
      <td align="right"><?php echo $PPT->Price($order->order_coupon,$currency_symbol,$GLOBALS['premiumpress']['currency_position'],1); ?> <?php if(strlen($order->order_couponcode) > 1){ echo "(".$order->order_couponcode.")"; } ?></td> 
    </tr>  
<?php } ?>              
     <tr> 

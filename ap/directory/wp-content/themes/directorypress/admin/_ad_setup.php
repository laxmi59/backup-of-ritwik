...
<table class="maintable" style="background:white;">
	...
	<tr class="mainrow">
        ...
        <legend>Hide Page Displays</legend>
...
?>      
 <p class="ppnote1">You can set the display order for pages using the normal page order settings or installing <a href="http://wordpress.org/extend/plugins/my-page-order/" target="_blank">this plugin.</a></p>  
        ...
        <legend>Footer Display Pages</legend>
        
        <p class="ppnote">Here you can tick any of the boxes next to pages you DO WANT to be displayed in your footer section.</p>  
	...
	<?php
		...
		print '<div style="background:#efefef; padding:8px; border:1px solid #ddd; font-size:16px; font-weight:bold;">
		<input name="footer_nav_page['.$i.']" type="checkbox" value="'.$Page->ID.'"';
...
<?php /* ============================ 1 ================================= */ ?>
<tr class="mainrow"><td></td><td class="forminp">
		<p><b>Website Logo (W: 350px  / H: 80px )</b></p>
...
<p class="ppnote">Here you enter the link to your website logo. Accepts both image name and full http:// image link. Note not all child theme layouts are the same and therefore the logo size may vary.</p>  

...
<ul>
    ...
    <?php if(strtolower(constant('PREMIUMPRESS_SYSTEM')) == "comparisonpress" ){ ?><li><a rel="premiumpress_tab5" href="#">Google Product Search</a></li><?php } ?>
</ul>
</div>
...
<table class="maintable" style="background:white;">	
	...
	<tr class="mainrow">
		<td class="titledesc">Google Product Search API Key</td>

		<td class="forminp">
			<input name="adminArray[google_productsearch_api]" type="text" class="txt" style="width: 450px;" value="<?php echo get_option("google_productsearch_api"); ?>" /><br />
			<small> You can get one by clicking on the following url: <a href="https://code.google.com/apis/console/" target="_blank">https://code.google.com/apis/console/</a></small>
		</td>
	</tr> 

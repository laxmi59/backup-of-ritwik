...
<table class="maintable">
	...
	<tr class="mainrow"><td></td><td class="forminp" valign="top">
		...
		<select name="adminArray[display_listing_status]" style="width: 240px;  font-size:14px;">
                ...
                <option value="pending" <?php if(get_option("display_listing_status") =="pending"){ print "selected";} ?>>Pending Review (Requires Admin Approval)</option>
          ...
          <p><b> <input type="checkbox" name="pak_auto_free" value="1" <?php if(get_option("pak_auto_free") ==1){ echo "checked"; } ?>>Auto Approve Free Listings</b></p>

      <p class="ppnote">This will override the option above to auto approve package listings which are free to submit.</p>
...
<?php $i++; } } ?>
      ...
      <p class="ppnote">Turn on/off the dislpay of custom fields within the list of features on the packages page.</p>

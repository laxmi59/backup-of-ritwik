...
}elseif(isset($_POST['feed']) && ( strtolower(constant('PREMIUMPRESS_SYSTEM')) == "shopperpress" || strtolower(constant('PREMIUMPRESS_SYSTEM')) == "classifiedstheme"  || strtolower(constant('PREMIUMPRESS_SYSTEM')) == "comparisonpress") ){
...
if(isset($_POST['tickemeamazon'])){

	// TURNS ON/OFF USER REGISTRATION
	$allow1 = (int)trim($_POST['comparisonpress_importamazon']);
	update_option("comparisonpress_importamazon", $allow1);

...
<div id="premiumpress_tab1" class="content">
	...
	if(isset($_GET['act']) && $_GET['act'] == "deldefault"){
		...
		$fileS = filesize(get_option("imagestorage_path").$fi);
	
		if(in_array($fileS,$badArraySizes)){ @unlink(get_option("imagestorage_path").$fi); }
	...
	<small><b><?php  echo $fi." ".$fileS; ?></b></small>
	</div>
	<?php $checkbox++; } } } } ?>
...
<!--<a href="admin.php?page=images&act=deldefault">test</a>-->

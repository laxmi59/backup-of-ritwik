...
<td class="tc"><a class="ico-comms" href="edit.php?post_type=page"><?php echo $count_pages->publish; ?></a></td>
<td><img src="<?php if(defined('THEME_WEB_PATH')){ echo THEME_WEB_PATH; }else{ echo $GLOBALS['template_url']; } ?>/images/premiumpress/led-ico/find.png" align="middle">  <a href="edit.php?post_type=page">View</a></td>
</tr>

...
if(is_home() && !isset($_GET['s']) && !isset($_GET['search-class']) ){
	...
	//if(strpos($query_string, "tag=") === false) { }else{ $query_string = str_replace("&post_type=post","&post_type=article_type", $query_string); } // remove post type to allow all tag searches

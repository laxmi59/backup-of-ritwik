  ...
  <tr>
	...
	<tr>
	 ...
	 <tr>
	  ...
	  <td align="left"><input type="text" name="product_url" id="product_url" value="<?php echo $editProduct->product_url?>" /><br />
	  <span style="font-size:11px">Ex: http://google.com/</span>
	  </td>
	  </tr>
	   <?php if($_GET['id']){?>
	  <tr>
	...
	<tr>
	  ...
	  <td align="left"><div id="poststuff"><?php the_editor( $editProduct->product_short_desc, $id = 'product_short_desc', $prev_id = 'title', $media_buttons = FALSE, $tab_index = 2)?></div><?php /*<textarea name="product_short_desc" id="product_short_desc" cols="30" rows="3"><?php echo $editProduct->product_short_desc?></textarea>*/?></td>
	  </tr>
	<?php /*?><tr>
	  <td height="30" align="left"><strong>Product Description </strong></td>

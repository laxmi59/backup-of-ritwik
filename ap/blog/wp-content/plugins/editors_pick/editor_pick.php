...
<div id="contentNot">
<table>
<tr><td><strong>Select Articles</strong></td><td><strong>Articles without Editor's Pick</strong></td></tr>
<tr>
<td>
 <select name='notedit1' id="notedit1" style='height:200px; width:400px;' size='200'>
 <?php $postsel1=mysql_query("select post_title, ID from wp_posts where post_status in('publish', 'pending', 'future') and post_type='post'");

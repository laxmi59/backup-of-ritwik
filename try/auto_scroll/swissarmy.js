...
document.write('<div align="center"><input id="prev'+this.issid+'" type="image" src="'+previmg+'" onclick="iss['+this.issid+'].changeimg(false, \'nav\');">\n'+
(this.no_auto? '&nbsp;&nbsp;&nbsp;' : ' <input id="gostp'+this.issid+'" type="image" src="'+(this.g_fPlayMode? playimg : stopimg)+'" onclick="iss['+this.issid+'].gostop(this);" title="Stop">\n')+
' <input id="next'+this.issid+'" disabled type="image" src="'+nextimg+'" onclick="iss['+this.issid+'].changeimg(true, \'nav\');">'+(this.jumpto? brs+'Jump to: <input disabled type="text" size="'+this.imgs.length.toString().length+'" id="goto'+this.issid+'" onkeydown="iss['+this.issid+'].jumper(event);"><input id="go'+this.issid+'" type="button" onclick="iss['+this.issid+'].jumper();" value="GO">' : '')+'<\/div>')

...
arrowimages: {down:['downarrowclass', '', 30], right:['rightarrowclass', '']},
	...
	$headers.each(function(i){ //loop through each LI header
		...
		$curobj.hover(
			function(e){
				...
				menuleft=(this._offsets.left+menuleft+this._dimensions.subulw>jQuery(window).width())? (this.istopheader && setting.orientation!='v'? -this._dimensions.subulw+this._dimensions.w : -this._dimensions.w) : menuleft //calculate this sub menu's offsets from its parent

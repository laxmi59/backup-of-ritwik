...
$.widget("ui.dialog", {
	...
	_create: function() {
		...
		var self = this,
			...
			uiDialogTitlebarClose1 = $( "<div class='bottom-thanks'></div>" )
				.addClass( " " )
				.attr( "role", "button" )
				.click(function( event ) {
					event.preventDefault();
			...
			uiDialogTitlebarCloseText1 = ( self.uiDialogTitlebarCloseText1 = $( "<span>" ) )
				.addClass( "" )
				.text( options.closeText1 )
				.appendTo( uiDialogTitlebarClose1 ),
	...
	close: function( event ) {
		...
		document.cookie = "newspop=2;path=/;expires="+exdate.toUTCString();
	...
	_setOption: function( key, value ) {
		...
		switch ( key ) {
			...
			case "closeText1":
				// ensure that we always pass a string
				self.uiDialogTitlebarCloseText1.text( "" + value );
				break;
			case "dialogClass":
				uiDialog

...
$myfeed = new RSSFeed();
$myfeed->SetChannel('http://www.casinoaffiliateprograms.com/xml.rss',
          ...
          'My copyright text',
                  'me',
          'my subject');
$myfeed->SetImage('http://www.casinoaffiliateprograms.com/logo.png');
$arraylink=array("revenue-giants/","fortune-affiliates/","bet365-affiliates/");
$arrayname=array("revenue giants","fortune affiliates","bet365 affiliates");
$arraydesc=array("desc of revenue giants","desc of fortune affiliates","desc of bet365 affiliates");
for($i=0; $i<sizeof($arraylink);$i++){
	$myfeed->SetItem('http://www.casinoaffiliateprograms.com/affiliate-programs/'.$arraylink[$i],
                   $arrayname[$i],
                   $arraydesc[$i]);
}

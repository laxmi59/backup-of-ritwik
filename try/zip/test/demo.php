...
mysql_select_db('ziptest') or die(mysql_error()); 
...
echo '<h3>A sample calculating the distance between 2 zip codes: 00613 and 46011</h3>';

$z = new zipcode_class;

$miles = $z->get_distance(00613, 46011);

if ($miles === false) echo 'Error: '.$z->last_error;
else echo "Zip code <b>97214</b> is <b>$miles</b> miles away from <b>46011</b>.<br />";
...
echo '<h3>A sample getting all the zip codes withing a range: 2 miles from 46011</h3>';

$zips = $z->get_zips_in_range('45767', 10, _ZIPS_SORT_BY_DISTANCE_ASC, true); 
...
if ($zips === false) echo 'Error: '.$z->last_error;
   ...
   foreach ($zips as $key => $value) {
      echo "Zip code <b>$key</b> is <b>$value</b> miles away from <b>46011</b>.<br />";
   }

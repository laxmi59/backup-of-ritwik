...
<div class="container">
  ...
  <form method="post" action="includes/customer.php" id="myForm" onsubmit="return CheckForm()" class="contactform" style="padding:0px">
      ...
      <div class="pas1" style="margin-top: 10px;"> <span style="font-size: 10px; color: rgb(0, 103, 183);"> Are your billing address <br>
        ...
        <div id="nots" style="margin-top: 5px; display: none;">
          <div class="pas1" style="margin-top: 10px;">
            ...
            <div class="field-widget">
              <input name="billingaddress" size="40" id="billingaddress" class="required" title="Please enter address" value="" type="text">
            </div>
          </div>
          <div class="spacer"></div>
          <div class="pas1">
...
-->
            ...
            <div class="field-widget" id="stateSelect22text">
              <input type="text" name="stateSelect22text"  value="" id="stateSelect22text"/>
              <!--              <script type="text/javascript">initCountry2('US'); </script>
-->
            </div>
          </div>

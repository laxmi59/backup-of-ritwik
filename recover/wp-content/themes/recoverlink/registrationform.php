...
<div class="container orange">
 ...
 <br/><br/>
   <form method="post" action="<?php echo get_option('siteurl'); ?>/creditcarddetails" id="myForm" onsubmit="return CheckForm()" class="contactform" style="padding:0px">
	...
	<?php if($_REQUEST['customer']!="" && isset($_REQUEST['customer'])) { ?>
         ...
         <div id="pas">
        New User Registration <input type="radio" name="user" id="newuser" value="newuser" onclick="window.location='<?php echo get_option('siteurl'); ?>/registerform?customer=nolabel';" checked="checked" class="radio-bt" /><br />
		Existing User, Requesting for more Labels? <input type="radio" name="user" id="olduser" value="olduser" onclick="displaycode(this.value);" class="radio-bt"/>            
    </div>
	
	
	<div id="exsistcodediv" style="margin-left:167px;">
         
       <div style="float:left; margin:5px 5px 0 0;"> Please enter your existing active label here: </div>        
          <input  name="exsistcode" size="40" id="exsistcode" title="Exsisting Code" value="" type="text" style="white-space:nowrap; float:left"> <input type="button" style="width:70px; float:left; margin:0 0 0 10px;" value="submit" onclick="getformdata()"  class="submit" /> </div>
       </div>
    
	<?php } ?>
	<div id="formdiv">
  <?php //echo registrationtable(0); 
  echo ' <h3> Sign-In Information </h3>
    <div id="pas">
      <div class="pas1">
    ...
    <div id="pass">
      <div class="pas1">
        ...
        <div class="field-widget">
          <input name="field3" size="40" id="field3" class="validate-password" title="Enter a password greater than 6 characters" type="password" value="'.base64_decode($getusercontdet['password']).'">
        </div>
      </div>
      <div class="spacer"></div>
      <div class="pas1">
    ...
    <div id="pass">
      ...
      <div class="pas1">
        ...
        <div class="field-widget">
          <select id="countrySelect" name="country" class="required inputf" onchange="populateState(this)">'.getSelectList($arrCountry,"United States").'
      ...
      <div class="pas1">
        ...
        <div class="field-widget" id="billstatesdiv">
          <select id="stateSelect" name="stateSelect" class="required inputf">
            '.getSelectList($arrStates,$stateSelect).'
          </select>
        </div>
          ...
          <div class="pas1">
            ...
            <div class="field-widget">
              <select id="countrySelect2" class="inputf" name="countrySelect2" onchange="checkState2(this)">
               '.getSelectList($arrCountry,"United States").'
              </select>
            </div>
          </div>
          <div class="spacer"></div>
          <div class="pas1">
            ...
            <div class="field-widget" id="stateSelect22">
              <select id="stateSelect2" class="inputf" name="stateSelect2">
               '.getSelectList($arrStates,$stateSelect2).'
              </select>
             
            </div>
            <div class="field-widget" id="stateSelect22text">
              <input type="text" name="stateSelect2"  value="'.$getusercontdet['shipping_state'].'" id="stateSelect22text"/>
            </div>
          </div>
          <div class="spacer"></div>
          <div class="pas1">

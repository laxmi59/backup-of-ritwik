...
{
 if (file_exists("uploaded_images/" . $_FILES["list_photo"]["name"]))
      {
      ...
      move_uploaded_file($_FILES["list_photo"]["tmp_name"],"uploaded_images/" . $_FILES["list_photo"]["name"]);
	...
	$insert=mysql_query("insert into `real-list` values(`list_id`, `r_id`, 'admin', '".$abc."', '$list_type', '$list_property', '$list_project', '$list_country', '$list_city', '$list_loc', '$lat', '$long', '$list_area', '$list_price', '$list_pricing', '$list_bedroom', '$list_floor_no', '$list_floors', '$list_age', '$list_items', '$list_face', '$list_own', '$flr', '$list_desc', now(),'a','$photo')");

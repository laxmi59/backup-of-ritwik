...
<tr>
	...
	<? 	//$a=new list2();
		if($_GET['act']=='listactive'){
			...
			$filePath="main.php?lk=home&act=adminlist&";
			...
			//echo "select * from `real-list` where `post_by`='admin' LIMIT $start, $q_limit";
			$filePath="main.php?lk=home&act=adminblock&";
		}
	...
	<tr class="tabcolor">
		...
		<td class="style4" style="padding-left:10px;">
			<div align="center">
			  <? if($_GET['act']=='listactive'){?>
			  <a href="main.php?lk=home&act=block&id=<?=$xx['list_id']?>&name=<?="listactive"?>" class="b">Block</a>
		      <? }else if($_GET['act']=='listnew'){?>
			  <a href="main.php?lk=home&act=accept&id=<?=$xx['list_id']?>&name=<?="listnew1"?>" class="b">Active</a>
			  <a href="main.php?lk=home&act=block&id=<?=$xx['list_id']?>&name=<?="listnew2"?>" class="b">Block</a>
		      <? }else if($_GET['act']=='listblock'){?>
			  <a href="main.php?lk=home&act=accept&id=<?=$xx['list_id']?>&name=<?="listblock"?>" class="b">Active</a>
		      <? }else if($_GET['act']=='adminlist'){?>
			  <a href="main.php?lk=home&act=block&id=<?=$xx['list_id']?>&name=<?="adminblock"?>" class="b">Block</a>
			  <a href="fast1.php?id=<?=$xx['list_id']?>" class="b">Edit</a>
		      <? }else if($_GET['act']=='adminblock'){?>
			  <a href="main.php?lk=home&act=accept&id=<?=$xx['list_id']?>&name=<?="adminactive"?>" class="b">Active</a>
		      <? }?>		
		    </div></td>
	</tr>
	...
	<tr class="tabcolor">
		...
		<td class="style4" style="padding-left:10px;">
			<div align="center">
			  <? if($_GET['act']=='postactive'){?>
			  <a href="main.php?lk=home&act=block&id=<?=$xx['req_id']?>&name=<?="postactive"?>" class="b">Block</a>
		      <? }else if($_GET['act']=='postnew'){?>
			  <a href="main.php?lk=home&act=accept&id=<?=$xx['req_id']?>&name=<?="postnew1"?>" class="b">Active</a>
			  <a href="main.php?lk=home&act=block&id=<?=$xx['req_id']?>&name=<?="postnew2"?>" class="b">Block</a>
		      <? }else if($_GET['act']=='postblock'){?>
			  <a href="main.php?lk=home&act=accept&id=<?=$xx['req_id']?>&name=<?="postblock"?>" class="b">Active</a>
		      <? }?>		
		    </div></td>
	</tr>
	<? }}?>
	...
	<table border="0"  width="90%" align="center" cellpadding="0" cellspacing="0" class="innertab">
		...
		<tr class="tabcolor">
			...
			<td class="style4">
		      ...
		      <div align="center">
		        <? if($_GET['act']=='active'){?>
		        <a href="main.php?lk=home&act=block&id=<?=$active['r_id']?>&name=<?="regactive"?>" class="b">Block</a>
		        <? }else if($_GET['act']=='new'){?>
		        <a href="main.php?lk=home&act=accept&id=<?=$active['r_id']?>&name=<?="regnew1"?>" class="b">Active</a>
		        <a href="main.php?lk=home&act=block&id=<?=$active['r_id']?>&name=<?="regnew2"?>" class="b">Block</a>
		        <? }else if($_GET['act']=='block'){?>
		        <a href="main.php?lk=home&act=accept&id=<?=$active['r_id']?>&name=<?="regblock"?>" class="b">Active</a>
		        <? }?>			
                </div></td>
		</tr>
		<tr class="tabcolor"><td colspan="7">&nbsp;</td></tr>
	...
	<? if($_GET['act']=='accept'){
		...
		if($_GET['name']='adminactive'){
			$update=mysql_query("update `real-list` set `list_status`='a' where `list_id`=".$_GET['id']."");
			echo "<script>location.replace('main.php?lk=home&act=adminblock')</script>";
		}
		////////////////////////// for users///////////////////////////////
	...
	<? if($_GET['act']=='block'){
		...
		if($_GET['name']='adminblock'){
			$update=mysql_query("update `real-list` set `list_status`='d' where `list_id`=".$_GET['id']."");
			echo "<script>location.replace('main.php?lk=home&act=adminlist')</script>";
		}
		////////////////////////// for users///////////////////////////////

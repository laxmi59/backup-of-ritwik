...
<body onLoad="load()" onUnload="GUnload()" ><!--onsubmit="return validateForm1(this)"-->
<form method="post" name="pgenerate"  action="listsave.php">
<table width="100%" align="center" cellpadding="0" cellspacing="0" class="tabcolor">
...
<tr>
	...
	<tr class="tabcolor">
		...
		<td>:</td>
		<td>
		<select name="list_city" style="width:160px">

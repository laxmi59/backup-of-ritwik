		   ...
		   if(isChosen(reg.country))
		   {
			/*if(isNotEmpty(reg.pc,"Postal Code should not be Empty"))
			{
			 ...
			 {*/
			  ...
			  if(email(reg.mail))
			  {
			   if (isNotEmpty(reg.pw,"password field should not be Empty")) 
			   {
			   if(pass(reg.pw))
			   {
				if (isNotEmpty(reg.rpw,"password field should not be Empty")) 
				{
				if (samepass(reg.pw,reg.rpw))
				{
				 if(isNotEmpty(reg.amail,"Email Id should not be Empty"))
				 {	
				  if(email(reg.amail))
			  	  {

...
<? if($_POST['btnNext']){
  ...
  <tr>
    ...
    <td width='66%'>&nbsp;</td>
		...
		$to = "poul@fairman-financial.couk";
...
dw_Tooltip.content_vars = {    
	L1: '<img src="arrowup.gif" style="width:20px;" /><table bgcolor="#57C4C1" style="border:1px solid;" cellpadding="0" cellspacing="0"><tr><td style="padding-left:5px;color:#4C1F0C;font-size: 15px">Get a Payday Loan fast - Immediate Online Decision</td></tr><tr  bgcolor="#FFFFFF"><td style="padding-left:5px"><a href="index.html"><p>With our State of the Art finance technology, we are capable of offering you a fast, efficient <strong>paperless</strong> process, whereby your application will be <strong>instantly processed and approved</strong>, based on the information provided by you.</p><p>Once approved, you will also have the option to sign for your Payday loan in just minutes conveniently online!</p></td></tr></table>',
   L2: '<img src="arrowup.gif" style="width:20px;" /><table bgcolor="#57C4C1" style="border:1px solid;" cellpadding="0" cellspacing="0"><tr><td style="padding-left:5px;color:#4C1F0C;font-size: 15px">Your Payday loan Information is 100% Secure</td></tr><tr  bgcolor="#FFFFFF"><td style="padding-left:5px"><a href="index.html"><p>For your security, all information supplied is protected by our leading edge, 128-bit <span class="caps">SSL</span> Encryption technology ensuring your Privacy is Protected every step of the way.</p></td></tr></table>',
   L3: '<img src="arrowup.gif" style="width:20px;" /><table bgcolor="#57C4C1" style="border:1px solid;" cellpadding="0" cellspacing="0"><tr><td style="padding-left:5px;color:#4C1F0C;font-size: 15px">Your Payday loan Information is 100% Secure</td></tr><tr  bgcolor="#FFFFFF"><td style="padding-left:5px"><a href="index.html"><p>For your security, all information supplied is protected by our leading edge, 128-bit <span class="caps">SSL</span> Encryption technology ensuring your Privacy is Protected every step of the way.</p></td></tr></table>',
   L4: '<img src="arrowup.gif" style="width:20px;" /><table bgcolor="#57C4C1" style="border:1px solid;" cellpadding="0" cellspacing="0"><tr><td style="padding-left:5px;color:#4C1F0C;font-size: 15px">No Credit Scoring needed for Payday Loan approval</td></tr><tr  bgcolor="#FFFFFF"><td style="padding-left:5px"><a href="index.html"><p>All Payday loan applications are approved based primarily on affordability regardless of your credit rating and therefore don&#8217;t require the need for any credit checks.</p></td></tr></table>', 
}
...
<select name="drpPayDay" id="drpPayDay" style="width: 40px;">
  ...
  <tr>
	...
	<a href="terms-of-use.html" target="_blank">Terms of Use</a> &middot; 
	<a href="privacy-polacy.html" target="_blank">Privacy Policy</a> &middot; 
	<a href="data-protection-policy.html" target="_blank">Data Protection Policy</a> &middot; 
	<a href="anti-spam-policy.html" target="_blank">Anti-Spam Policy</a> &middot; 

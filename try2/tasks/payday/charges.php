...
<img src="images/h1.jpg" width="319" height="169" /><img src="images/h2.jpg" width="319" height="169"/><img src="images/h3.jpg" width="317" height="169" /></td>
  ...
  <tr>
    <td colspan="3" align="left" valign="top"><table width="953" height="13" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="116" align="left" valign="top"><a href="charges.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image20','','images/b44.jpg',1)"><img src="images/b44.jpg" name="Image20" width="116" height="34" border="0" id="Image20" /></a><a href="charges.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image7','','images/b44.jpg',1)"></a></td>
  ...
  <tr>
    <td height="533" colspan="3" align="center" valign="middle" bgcolor="#FFFFFF" class="style15"><table width="932" cellspacing="0" cellpadding="0">
      <tr>
        <td width="641" align="left" valign="top"><img src="images/but-04-100.jpg" width="305" height="94" /></td>
      ...
      <tr>
        ...
        <td rowspan="3" align="left" valign="top"><table width="100" cellspacing="0" cellpadding="0">
          <tr>
            <td><img src="images/pic4-1-001.jpg" width="275" height="125" /></td>
          </tr>
          <tr>
            <td><img src="images/pic4-1-002.jpg" width="275" height="126" /></td>
          </tr>
          <tr>
            <td><img src="images/pic4-1-003.jpg" width="275" height="125" /></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td height="399" align="center" valign="top" background="images/bg-04-2.jpg"><table width="610" cellspacing="0" cellpadding="0">
          <tr>
            <td width="608"><p>Payday loans serve as a short term financial solution and are not  intended for lengthy loan periods. Our panel of top UK payday loan  lenders&rsquo; loan charges will vary. You will be informed of the exact  charges applicable before agreeing to the payday loan terms in your  agreement. However, you can typically expect to repay &pound;20 for every &pound;80  borrowed or &pound;25 for every &pound;100 borrowed.</p>
              <p>Payday loans are available for any amount between &pound;80 and &pound;750.</p>
              <p>Typical 1355% APR* over a period of 30 days.</p>
              <p><strong>No administration charges.</strong></p>
              <p>As the typical APR  may seem high, please always remember that payday loans have an  extremely short repayment term of between 30 and 60 days compared to  that of conventional loans and therefore a yearly APR % will most likely appear deceptive.</p>
              <p>Here are a few examples of what you can expect to repay. These amounts will however vary from lender to lender.</p>              </td>
          </tr>
          <tr>
            <td height="98" align="center" valign="top" ><table border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" style="border:#666666 1px solid;">
              <tbody>
                <tr>
                  <td width="66" height="35">Loan</td>
                  <td width="69">Charges</td>
                  <td width="84">Repayment</td>
                </tr>
                <tr>
                  <td height="27">&pound;80.00</td>
                  <td>&pound;20.00</td>
                  <td>&pound;100.00</td>
                </tr>
                <tr>
                  <td height="25">&pound;150.00</td>
                  <td>&pound;37.50</td>
                  <td>&pound;187.50</td>
                </tr>
                <tr>
                  <td height="30">&pound;300.00</td>
                  <td>&pound;75.00</td>
                  <td>&pound;375.00</td>
                </tr>
                <tr>
                  <td height="27">&pound;450.00</td>
                  <td>&pound;112.50</td>
                  <td>&pound;562.50</td>
                </tr>
                <tr>
      ...
      <tr>
        <td align="left" valign="top"><img src="images/bg-04-3.jpg" width="641" height="12" /></td>
        <td align="left" valign="top">&nbsp;</td>
        </tr>
